...
public class JuegoAdivinanzas {
    public static void main(String[] args) {
        ...
        while (adivinanza != numeroSecreto && intentos < INTENTOS_MAXIMOS){
            System.out.print("Adivina el números ecreto (1-50): ");
            adivinanza = consola.nextInt();

            // Agregar una ayuda para orientar el jugador
        ...
        if (adivinanza == numeroSecreto){
            ...
            System.out.printf("Lo siento, has suèrado el máximo de intentos: %d%n", INTENTOS_MAXIMOS);
